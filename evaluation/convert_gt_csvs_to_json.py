...
def main(dataset_root_path, subset):
    ...
    with open(f"cell_gt_{subset}.json", "w") as g:
        json.dump(gt_json, g,indent=4)
        print(f"JSON file saved in {os.getcwd()}/cell_gt_{subset}.json")


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("-d", "--dataset_root_path", type=str, required=False,default='/home/f1105/1TB/MYP/OCELOT/ocelot2023',
                        help="Path to the dataset. (e.g. /home/user/ocelot2023_v0.1.1)")
    parser.add_argument("-s", "--subset", type=str, required=False, default='train',
